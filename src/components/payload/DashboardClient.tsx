...
export default function DashboardClient({
  ...
  return (
    <div className="min-h-screen bg-[var(--theme-elevation-0)] py-8 px-4 sm:px-6 lg:px-8 font-sans">
      {/* Header Panel */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between pb-6 mb-8 border-b border-[var(--theme-elevation-200)]">
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[var(--theme-elevation-900)]">
            Resumen de Ventas y Analítica
          </h1>
          <p className="mt-1 text-sm text-[var(--theme-elevation-400)]">
            Monitorea el rendimiento de tus tiendas en tiempo real. Bienvenido, <span className="font-semibold text-[var(--theme-accent)]">{userEmail}</span>.
          </p>
        </div>
        ...
        {tenants.length > 0 && (
          <div className="mt-4 sm:mt-0 flex flex-col sm:flex-row sm:items-center gap-3">
            <label className="text-xs font-bold uppercase tracking-wider text-[var(--theme-elevation-400)]">
              Organización / Tienda:
            </label>
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        {/* Total Sales KPI */}
        <div className="bg-[var(--theme-elevation-100)] border border-[var(--theme-elevation-200)] rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-[var(--theme-elevation-400)]">
              Ventas Totales (30d)
            </span>
            <span className="p-2 bg-emerald-500/10 rounded-lg text-[var(--theme-accent)]">
          ...
          <div className="mt-3">
            <h3 className="text-2xl font-bold tracking-tight text-[var(--theme-elevation-900)]">
        ...
        <div className="bg-[var(--theme-elevation-100)] border border-[var(--theme-elevation-200)] rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow duration-200">
          ...
          <div className="mt-3">
            ...
            <span className="text-xs text-[var(--theme-elevation-400)] font-medium">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        {/* Sales Chart Section */}
        <div className="lg:col-span-2 bg-[var(--theme-elevation-100)] border border-[var(--theme-elevation-200)] rounded-2xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-lg font-bold text-[var(--theme-elevation-900)]">
                Tendencia de Ventas Diarias
              </h2>
              <p className="text-xs text-[var(--theme-elevation-400)]">
                Historial de facturación de los últimos 7 días
              </p>
            </div>
            {hoveredIdx !== null && (
              <div className="bg-[var(--theme-elevation-150)] px-3 py-1 rounded-lg border border-[var(--theme-elevation-200)] text-xs text-[var(--theme-elevation-800)] font-semibold transition-all">
                {points[hoveredIdx].data.date}: <span className="text-[var(--theme-accent)]">{formatCurrency(points[hoveredIdx].data.sales)}</span> ({points[hoveredIdx].data.orders} ped.)
              </div>
            )}
          </div>
        ...
        <div className="bg-[var(--theme-elevation-100)] border border-[var(--theme-elevation-200)] rounded-2xl p-6 shadow-sm flex flex-col">
          <div className="mb-4">
            <h2 className="text-lg font-bold text-[var(--theme-elevation-900)] flex items-center gap-2">
          ...
          <div className="flex-1 overflow-y-auto space-y-3 max-h-[220px] pr-1">
            {lowStockItems.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center py-6 text-center text-[var(--theme-elevation-400)]">
              ...
              lowStockItems.map((item, idx) => (
                ...
                >
                  <div className="min-w-0 flex-1 pr-2">
                    ...
                    <span className="text-[9px] text-[var(--theme-elevation-400)] font-mono block">
                      SKU: {item.sku}
                    </span>
                  </div>
      ...
      <div className="bg-[var(--theme-elevation-100)] border border-[var(--theme-elevation-200)] rounded-2xl p-6 shadow-sm">
        ...
        {recentOrders.length === 0 ? (
          <div className="text-center py-8 text-[var(--theme-elevation-400)]">
              ...
              <tbody className="divide-y divide-[var(--theme-elevation-200)]">
                {recentOrders.map((order) => (
                  <tr key={order.id} className="hover:bg-[var(--theme-elevation-50)] transition-colors">
                    <td className="px-4 py-3.5 whitespace-nowrap text-sm font-bold text-[var(--theme-elevation-900)]">
                      {order.orderCode}
                    </td>
                    <td className="px-4 py-3.5 whitespace-nowrap text-sm text-[var(--theme-elevation-800)]">
                      <div className="font-semibold">{order.customerName}</div>
                      <div className="text-xs text-[var(--theme-elevation-400)]">{order.customerEmail}</div>
                    </td>
                    <td className="px-4 py-3.5 whitespace-nowrap text-sm text-[var(--theme-elevation-400)] font-medium">
                    ...
                    <td className="px-4 py-3.5 whitespace-nowrap text-sm font-bold text-[var(--theme-elevation-900)] text-right">
